...
export const projects = [
  ...
  },
  {
    ...
    status: "Completed",
    description:
      "A real-time Bangladeshi market price tracker for everyday essentials like oil, gas, meat, vegetables, poultry, and more. Built with React and Zustand for smooth, efficient state management.",
    tech: [
  ...
  },
  {
    ...
    status: "Improving",
    description:
      "Three.js 3D Scene A real-time 3D environment with a glowing sphere, orbital rings, particle systems, and a star field. Built with pure Three.js showcasing advanced geometry, lighting, and scene management.",
    tech: [
