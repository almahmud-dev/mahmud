...
import { HiOutlineBriefcase, HiArrowUpRight } from "react-icons/hi2";
import { FaGithub } from "react-icons/fa";
import { internshipProjects, internshipImages } from "@/src/helper";
...
export default function ExperienceCard() {
  return (
    <div className="relative flex gap-8">
      ...
      {/* Card */}
      <div className="flex-1 rounded-[28px] border border-black/5 dark:border-white/10 bg-white/70 dark:bg-white/3 backdrop-blur-xl p-7 sm:p-10 shadow-[0_10px_60px_rgba(124,58,237,0.08)]">
        {/* Top */}
        <div className="flex flex-col lg:flex-row gap-10">
          ...
          <div className="flex-1">
            ...
            <p className="text-secondary leading-[1.9] mt-6">
              Worked on real-world frontend projects using React.js, Next.js,
              Tailwind CSS, JavaScript, and TypeScript, focusing on responsive
              user interfaces and reusable component architecture. Gained
              practical experience with Firebase authentication, Cloudinary
              image optimization, Git & GitHub version control, and
              collaborative team workflows. Also worked with WordPress (CMS),
              domain & hosting management, and client communication while
              continuously learning new technologies through documentation and
            ...
            {internshipProjects.map((project, i) => (
              ...
              >
                ...
                <div className="relative w-full aspect-video overflow-hidden">
                  ...
                  <div className="absolute inset-0 bg-primary-dark/80 backdrop-blur-sm opacity-0 group-hover:opacity-100 transition-all duration-300 hidden md:flex flex-col items-center justify-center gap-3 p-4">
