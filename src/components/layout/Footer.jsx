  ...
  return (
    <footer className="border-t border-black/8 dark:border-white/8 bg-white dark:bg-[#080810]">
      <Container>
        <div className="py-10 md:py-14 grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-secondary/60 leading-relaxed max-w-xs">
              Full Stack MERN Developer focused on building modern, responsive and user-friendly web experiences.
            </p>
          ...
          {/* Nav */}
          <div className="space-y-4">
            <h3 className="text-xs font-bold uppercase tracking-widest text-secondary/40">Navigation</h3>
            <ul className="space-y-2">
              {navLinks.map((link) => (
                <li key={link}>
                  <a
                    href={`#${link.toLowerCase()}`}
                    className="text-sm text-secondary/70 hover:text-accent transition-colors duration-200"
                  >
                    {link}
                  </a>
                </li>
          ...
          {/* Social */}
          <div className="space-y-4">
            <h3 className="text-xs font-bold uppercase tracking-widest text-secondary/40">Connect</h3>
        ...
        <div className="border-t border-black/8 dark:border-white/8 py-5 flex flex-col sm:flex-row items-center justify-between gap-2 text-xs text-secondary/35">
